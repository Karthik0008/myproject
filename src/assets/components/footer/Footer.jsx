    ...
    <footer className="bg-gray-900 text-white py-8">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Salon Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Style & Shine Salon</h3>
          ...
          <div>
            ...
            <p className="text-gray-400">📧 info@styleandshine.com</p>
        ...
        <div className="text-center text-gray-500 mt-8">
          <p>© 2025 Style & Shine Salon. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
